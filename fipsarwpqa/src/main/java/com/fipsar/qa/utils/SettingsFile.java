...
public class SettingsFile {
	...
	public static void initSettingsFile() throws FipsarReporterException  {
	...
	public static void create(String paramString) throws FipsarReporterException  {
		...
		{
			throw new FipsarReporterException("Unable To Create Required Files for Custom Reports");
		}
	}

	public static void open() throws FipsarReporterException  {
		...
		{
			throw new FipsarReporterException("Settings File Not Available");
		}
		catch (IOException localIOException)
		{
			throw new FipsarReporterException("Unable To Create Required Files for Custom Reports");
	...
	public static void close() throws FipsarReporterException  {
		try
		{
	...
	public static void correctErrors() throws NumberFormatException, FipsarReporterException  {
	...
	public static int getHighestTestCaseNumber() throws FipsarReporterException  {
	...
	public static String get(String propertyKey) throws FipsarReporterException  {
		open();
	...
	public static void set(String key, String value) throws FipsarReporterException  {
		open();
