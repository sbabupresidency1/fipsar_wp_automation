...
import com.fipsar.qa.utils.AuthorDetails;
import com.fipsar.qa.utils.Directory;
import com.fipsar.qa.utils.Platform;
import com.fipsar.qa.utils.Steps;
import com.google.common.io.Files;

public class FipsarReports {
	private static WebDriver driver;
	public static final int MAX_BAR_REPORTS = 10;
	public static final String MESSAGE = "Fipsar Reporter: Preparing Reports";
	...
	private static void stepFailureHandler(ITestResult ITestResult, Steps Steps, LogAs logAs)  {
		if (logAs == LogAs.FAILED)
		{
			...
			if (Directory.continueExecutionAfterStepFailed) {
				...
				throw new FipsarReporterStepFailedException();
			}
			return;
		}
		buildReportData(Steps);
