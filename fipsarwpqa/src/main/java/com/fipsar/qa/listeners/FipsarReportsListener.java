package com.fipsar.qa.listeners;
...
import com.fipsar.qa.exceptions.FipsarReporterStepFailedException;
import com.fipsar.qa.utils.Attributes;
import com.fipsar.qa.utils.Directory;
import com.fipsar.qa.utils.Platform;
import com.fipsar.qa.utils.SettingsFile;
import com.fipsar.qa.utils.TestParameters;
import com.fipsar.qa.writers.ConsolidatedReportsPageWriter;
import com.fipsar.qa.writers.CurrentRunPageWriter;
import com.fipsar.qa.writers.HTMLDesignFilesJSWriter;
import com.fipsar.qa.writers.IndexPageWriter;
import com.fipsar.qa.writers.TestCaseReportsPageWriter;

public class FipsarReportsListener implements ITestListener, IExecutionListener, IReporter, ISuiteListener {

	static Logger log = Logger.getLogger(FipsarReportsListener.class.getName());
	int runCount = 0;
	...
	public void onTestSuccess(ITestResult result)  {
		try
		{
			...
			{
				result.setStatus(2);
				result.setThrowable(new FipsarReporterStepFailedException());
	...
	public static void setPlatfromBrowserDetails(ITestResult paramITestResult)  {
		Platform.prepareDetails(FipsarReports.getWebDriver());
	...
	public void generateIndexPage()  {
		...
		try
		{
			...
			IndexPageWriter.content(localPrintWriter, FipsarReports.indexPageDescription);
